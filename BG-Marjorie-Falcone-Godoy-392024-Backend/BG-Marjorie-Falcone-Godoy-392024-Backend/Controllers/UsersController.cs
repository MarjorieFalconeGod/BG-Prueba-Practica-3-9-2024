...
namespace BG_Marjorie_Falcone_Godoy_392024_Backend.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(BG_Marjorie_Falcone_Godoy_392024_BackendContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.User != null ? 
                          ...
                          Problem("Entity set 'BG_Marjorie_Falcone_Godoy_392024_BackendContext.User'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BG_Marjorie_Falcone_Godoy_392024_BackendContext.User'  is null.");
            }
            var user = await _context.User.FindAsync(id);
            if (user != null)
            {
